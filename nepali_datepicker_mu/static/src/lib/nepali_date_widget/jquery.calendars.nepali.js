/* http://keith-wood.name/calendars.html
   Nepali calendar for jQuery v2.0.0.
	...
	$.extend(NepaliCalendar.prototype, {
		...
		regionalOptions: { // Localisations
			'': {
				name: 'Nepali',
				epochs: ['BBS', 'ABS'],
				monthNames: ['बैशाख', 'जेठ', 'असार', 'सावन', 'भदौ', 'असोज',
				'कार्तिक', 'मंसिर', 'पौष', 'माघ', 'फागुन', 'चैत'],
				monthNamesShort: ['बैशाख', 'जेठ', 'असार', 'सावन', 'भदौ', 'असोज',
					'कार्तिक', 'मंसिर', 'पौष', 'माघ', 'फागुन', 'चैत'],
				dayNames: ['आईत', 'सोम', 'मंगल', 'बुध', 'बिही', 'शुक्र', 'शनि'],
				dayNamesShort: ['आईत', 'सोम', 'मंगल', 'बुध', 'बिही', 'शुक्र', 'शनि'],
				dayNamesMin: ['आईत', 'सोम', 'मंगल', 'बुध', 'बिही', 'शुक्र', 'शनि'],
