...
import {deviceContext} from "@web_o2b_responsive/components/ui_context.esm";
...
patch(LegacyControlPanel.prototype, "web_o2b_responsive.LegacyControlPanelMobile", {
    setup() {
        this._super();
        this.state = useState({
...
patch(ControlPanel.prototype, "web_o2b_responsive.ControlPanelMobile", {
    setup() {
        this._super();
        this.state = useState({
            mobileSearchMode: "",
...
patch(SearchBar, "web_o2b_responsive.SearchBarMobile", {
    template: "web_o2b_responsive.SearchBar",
});
